...
import mplcursors  # For interactive cursor on the plot

# Load the data from CSV
data = pd.read_csv('C:/Users/legen/OneDrive/YG/Excel/STCOKDATA/AAPL.XLS.csv')  # Apple stock data file path
...
plt.plot(future_dates[:-1], predicted_future_prices, color='red', label='Predicted Future Price')
