...
data = pd.read_csv('C:/Users/legen/OneDrive/YG/Excel/STCOKDATA/MSFT.csv')  # Update with Microsoft stock data file path
...
plt.title('Microsoft Stock Price Prediction\nLSTM Model Results')  # Title updated for Microsoft
plt.legend()
plt.show()
...
plt.xlabel('Time (Months)')
plt.ylabel('Stock Price (USD)')
plt.title('Microsoft Stock Price Prediction\nFuture 6 Months Forecast')  # Title updated for Microsoft
plt.legend()
plt.show()
